import{_ as s,o as n,c as a,R as l}from"./chunks/framework.xW0OlkBD.js";const d=JSON.parse('{"title":"vite 配置优化","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/node/vite.md","filePath":"frontend/node/vite.md","lastUpdated":1714988302000}'),p={name:"frontend/node/vite.md"},o=l(`<h1 id="vite-配置优化" tabindex="-1">vite 配置优化 <a class="header-anchor" href="#vite-配置优化" aria-label="Permalink to &quot;vite 配置优化&quot;">​</a></h1><p>vite.config.ts</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { resolve } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;path&#39;</span></span>
