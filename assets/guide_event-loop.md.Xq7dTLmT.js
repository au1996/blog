import{_ as s,o as n,c as a,R as l}from"./chunks/framework.xW0OlkBD.js";const p="/blog/assets/prototype.LSsO0Vih.png",o="/blog/assets/stack.fZ0Ytqd9.jpg",e="/blog/assets/heap.TBPv4KSs.jpg",c="/blog/assets/stack-heap.DueGljZj.png",t="/blog/assets/queue.xRN0hGhO.jpg",r="/blog/assets/js-stack.a5lepCAp.png",E="/blog/assets/event-loop-ui.izf-Iel7.png",y="/blog/assets/node-event-loop.QifeMqPv.png",b=JSON.parse('{"title":"【js 进阶】全篇干货 ！一篇文章让你彻底弄懂栈、堆、队列、执行栈、执行上下文、跟事件循环（Event Loop）的关系","description":"","frontmatter":{},"headers":[],"relativePath":"guide/event-loop.md","filePath":"guide/event-loop.md","lastUpdated":1714987180000}'),i={name:"guide/event-loop.md"},d=l(`<h1 id="【js-进阶】全篇干货-一篇文章让你彻底弄懂栈、堆、队列、执行栈、执行上下文、跟事件循环-event-loop-的关系" tabindex="-1">【js 进阶】全篇干货 ！一篇文章让你彻底弄懂栈、堆、队列、执行栈、执行上下文、跟事件循环（Event Loop）的关系 <a class="header-anchor" href="#【js-进阶】全篇干货-一篇文章让你彻底弄懂栈、堆、队列、执行栈、执行上下文、跟事件循环-event-loop-的关系" aria-label="Permalink to &quot;【js 进阶】全篇干货 ！一篇文章让你彻底弄懂栈、堆、队列、执行栈、执行上下文、跟事件循环（Event Loop）的关系&quot;">​</a></h1><h2 id="前言-本文背景" tabindex="-1">前言（本文背景） <a class="header-anchor" href="#前言-本文背景" aria-label="Permalink to &quot;前言（本文背景）&quot;">​</a></h2><p><a href="https://au1996.gitee.io/blog/guide/borwer-message.html">可以先看这篇消息队列文章</a></p><p>网上有很多讲解 <code>Event Loop</code> 的文章，但大多数都过于片面，少数相对全面的也仍有一些知识盲区，甚至一些文章还传播错误的知识，结果就是让我们 <code>似懂非懂</code>。这篇文章让你彻底弄懂！</p><h2 id="开始-前置知识点" tabindex="-1">开始（前置知识点） <a class="header-anchor" href="#开始-前置知识点" aria-label="Permalink to &quot;开始（前置知识点）&quot;">​</a></h2><p>已经了解 <code>JS数据类型</code>、<code>栈</code>、<code>堆</code>、<code>队列</code>、<code>执行栈</code>、<code>执行上下文</code> 的同学可以跳过这一段；</p><h3 id="js-数据类型" tabindex="-1">JS 数据类型 <a class="header-anchor" href="#js-数据类型" aria-label="Permalink to &quot;JS 数据类型&quot;">​</a></h3><p>JS 数据类型分为两大类：<code>原始类型 | 基本类型</code> 、<code>引用类型</code></p><p>原始类型包含七种：</p><ul><li><code>number</code></li><li><code>string</code></li><li><code>boolean</code></li><li><code>undefined</code></li><li><code>symbol (ES2015)</code></li><li><code>bigint (ES2020)</code></li><li><code>null (特殊的原始类型)</code></li></ul><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">typeof</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">666</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">===</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;number&#39;</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;">// true</span></span>
...
<span class="line"><span style="color:#24292e;">用户点击：会先冒泡出去，算两个点击事件（宏任务）；然后执行代码。</span></span></code></pre></div>`,116),F=[d];function u(g,C,h,m,A,B){return n(),a("div",null,F)}const v=s(i,[["render",u]]);export{b as __pageData,v as default};
