import{_ as s,o as n,c as a,R as l}from"./chunks/framework.xW0OlkBD.js";const p="/blog/assets/git.nbKc81Bv.png",h=JSON.parse('{"title":"git 速查表","description":"","frontmatter":{},"headers":[],"relativePath":"extend/git.md","filePath":"extend/git.md","lastUpdated":1714987180000}'),o={name:"extend/git.md"},e=l('<h1 id="git-速查表" tabindex="-1">git 速查表 <a class="header-anchor" href="#git-速查表" aria-label="Permalink to &quot;git 速查表&quot;">​</a></h1><p><img src="'+p+`" alt="git"></p><p>名词解释</p><ul><li><code>Workspace</code>: 工作区</li><li><code>Index / Stage</code>: 暂存区</li><li><code>Repository</code>: 仓库区(或本地仓库)</li><li><code>Remote</code>: 远程仓库</li></ul><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>暂存: 在下一次提交中的所有更改。</p><ul><li>对工作目录(working directory)中的文件进行更改。</li><li>使用<code>git add</code>命令将这些更改从工作目录(working directory)移动到暂存区(staging area)。</li><li>git 尚未保存更改。需要运行<code>git commit</code>命令将更改从暂存区(staging area)移动到本地存储库(local repository)。</li></ul><p>可以使用<code>git status</code>命令检查文件和暂存区的状态。如果未暂存要提交的更改，则不会保存更改。</p></div><h2 id="创建-git-仓库" tabindex="-1">创建 git 仓库 <a class="header-anchor" href="#创建-git-仓库" aria-label="Permalink to &quot;创建 git 仓库&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 创建本地库</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 克隆远程库</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">clone</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">&lt;</span><span style="color:#032F62;">repo_ur</span><span style="color:#24292E;">l</span><span style="color:#D73A49;">&gt;</span></span></code></pre></div><h2 id="添加文件" tabindex="-1">添加文件 <a class="header-anchor" href="#添加文件" aria-label="Permalink to &quot;添加文件&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 将修改文件提交至暂存区</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 修改上一次提交</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">commit</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-amend</span><span style="color:#24292E;"> [-m </span><span style="color:#032F62;">&quot;&lt;message&gt;&quot;]</span></span></code></pre></div><h2 id="查看状态" tabindex="-1">查看状态 <a class="header-anchor" href="#查看状态" aria-label="Permalink to &quot;查看状态&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 查看仓库状态</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 查看所有 log，并以提交图形显示</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">log</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--graph</span></span></code></pre></div><h2 id="文件删除" tabindex="-1">文件删除 <a class="header-anchor" href="#文件删除" aria-label="Permalink to &quot;文件删除&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 将文件从暂存区和工作区中删除</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 将文件从暂存区删除，保留在工作区</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">rm</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--cached</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">&lt;</span><span style="color:#032F62;">filenam</span><span style="color:#24292E;">e</span><span style="color:#D73A49;">&gt;</span></span></code></pre></div><h2 id="分支管理" tabindex="-1">分支管理 <a class="header-anchor" href="#分支管理" aria-label="Permalink to &quot;分支管理&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 创建分支</span></span>
...
<span class="line"><span style="color:#6A737D;"># @see https://docs.github.com/en/github/using-git/about-git-rebase</span></span>
<span class="line"><span style="color:#6A737D;"># @see https://git-scm.com/docs/git-rebase</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">rebase</span></span></code></pre></div><h2 id="标签管理" tabindex="-1">标签管理 <a class="header-anchor" href="#标签管理" aria-label="Permalink to &quot;标签管理&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 指定标签信息</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 推送所有标签</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">push</span><span style="color:#24292E;"> </span><span style="color:#032F62;">origin</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--tags</span></span></code></pre></div><h2 id="保存与恢复工作" tabindex="-1">保存与恢复工作 <a class="header-anchor" href="#保存与恢复工作" aria-label="Permalink to &quot;保存与恢复工作&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 保存工作状态</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 恢复并删除已保存工作状态</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">stash</span><span style="color:#24292E;"> </span><span style="color:#032F62;">pop</span></span></code></pre></div><h2 id="远程库操作" tabindex="-1">远程库操作 <a class="header-anchor" href="#远程库操作" aria-label="Permalink to &quot;远程库操作&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 关联远程库</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 拉取远程库分支与本地分支合并</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">pull</span><span style="color:#24292E;"> [remote] [remote_branch]</span></span></code></pre></div><h2 id="版本回退" tabindex="-1">版本回退 <a class="header-anchor" href="#版本回退" aria-label="Permalink to &quot;版本回退&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 回到之前版本，该版本之后的改变保存在暂存区(已执行add操作)</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 暂存区撤销所有文件更改</span></span>
<span class="line"><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">checkout</span><span style="color:#24292E;"> </span><span style="color:#032F62;">.</span></span></code></pre></div>`,23),t=[e];function c(r,y,i,E,F,g){return n(),a("div",null,t)}const C=s(o,[["render",c]]);export{h as __pageData,C as default};
